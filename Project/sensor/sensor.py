...
# NUEVO: Leer los tipos separados por comas y convertirlos en una lista
...
print(f"Starting Sensor {SENSOR_ID} at Lat: {LATITUDE}, Lon: {LONGITUDE}")
print(f"Collecting data for: {SENSOR_TYPES}")
